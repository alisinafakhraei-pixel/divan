...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="220" height="220" viewBox="0 0 1080 1080" style={{ marginRight: 48 }}>
          <path
            fill="#1c54d3"
